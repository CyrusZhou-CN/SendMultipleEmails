export default {
  ...
  template_new: "New",
  template_save: "Save",
  template_saveAs: "Save As",
  template_close: "Close",
  template_new_confirm: "The template has been modified. Do you want to save and continue?",
  template_save_confirm: "Do you want to save the data?",
  template_save_success: "Saved successfully!",
  template_save_as_title: "Enter Name",
  template_save_as_message: "Please enter the name of the template:",
  template_exit_confirm: "The template has been modified. Do you want to save before exiting?",
  ...
  isRequired: "Is empty",
  api_required: "Api address cannot be empty",
  before_handler_failed: "Predecessor operation failed",
  intercept_api_success: "Handle updates externally",
  no_id_found: "Updated _id not found",
